...
4. **تثبيت التبعيات الاختيارية (للوظائف الكاملة):**
    ```bash
...
| -------------------------- | ----------------------------------------------- | -------------------------------- |
| `APP_ENV`                  | بيئة التطبيق (production, development, testing) | `development`                    |
...
> **ملاحظة:** لا تشارك ملف `.env` أبداً - فهو مُضاف إلى `.gitignore` لحمايه.
> **تلميح:** اضبط `APP_ENV=production` لتمكين استعلامات SQL في بيئة الإنتاج.
...
│   │
│   ├── c18/            # معالجة التصنيف والروابط وأدوات التصنيف الإضافية
...
│   ├── c18/           # اختبارات c18 (تشمل المنطق المدمج من b18)
...
| b18     | معالجة التصنيف والروابط         | ✅     |
| c18     | أدوات وتحويلات التصنيف          | ✅     |
