...
class TestCheckEnTemps:
    ...
    def test_returns_false_for_skipped_category(self, mocker):
        ...
        mocker.patch("src.core.mk_cats.utils.check_en.skip_encats", ["Category:Skip"])
    ...
    def test_returns_true_when_no_category_data(self, mocker):
        ...
        mocker.patch("src.core.mk_cats.utils.check_en.skip_encats", [])
        mocker.patch("src.core.mk_cats.utils.check_en.find_LCN", return_value=None)
    ...
    def test_returns_true_when_no_templates(self, mocker):
        ...
        mocker.patch("src.core.mk_cats.utils.check_en.skip_encats", [])
        mocker.patch("src.core.mk_cats.utils.check_en.find_LCN", return_value={"Category:Test": {}})
    ...
    def test_returns_true_for_allowed_templates(self, mocker):
        ...
        mocker.patch("src.core.mk_cats.utils.check_en.skip_encats", [])
        mocker.patch("src.core.mk_cats.utils.check_en.NO_Templates_lower", ["badtemplate"])
        mocker.patch(
            "src.core.mk_cats.utils.check_en.find_LCN",
    ...
    def test_calls_find_lcn_with_correct_params(self, mocker):
        ...
        mocker.patch("src.core.mk_cats.utils.check_en.skip_encats", [])
        mock_find_lcn = mocker.patch("src.core.mk_cats.utils.check_en.find_LCN", return_value=None)
    ...
    def test_handles_empty_templates_list(self, mocker):
        ...
        mocker.patch("src.core.mk_cats.utils.check_en.skip_encats", [])
        mocker.patch("src.core.mk_cats.utils.check_en.find_LCN", return_value={"Category:Test": {"templates": []}})
